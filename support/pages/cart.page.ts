...
export class CartPage extends BasePage {
  ...
  private checkoutButton = (): Locator =>
    this.page.locator('[name="checkout"]');
  private agreeCheckoutTerms = (): Locator =>
    this.page.locator('[name="termsofservice"]');
  private checkoutAsAGuestButton = (): Locator =>
    this.page.locator(".checkout-as-guest-button");
